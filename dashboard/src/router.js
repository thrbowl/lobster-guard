...
const routes = [
  ...
  { path: '/edge-ingress', name: 'edge-ingress', component: () => import('./views/EdgeIngress.vue'), meta: { title: '边缘接入', icon: 'door', group: 'system' } },
  ...
  { path: '/access-logs', name: 'access-logs', component: () => import('./views/AccessLogs.vue'), meta: { title: '访问日志', icon: 'activity', group: 'im' } },
